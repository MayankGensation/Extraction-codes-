...
url = "https://sec2021.bihar.gov.in/claim-objection/Result9.aspx?D=0&PO=1"
...
csv_file = "gram_panchayat_mukhiya_results(9).csv"
...
# Start extraction from "अररिया"
districts = get_dropdown_options('//*[@id="ctl00_ContentPlaceHolder1_ddlDistrict"]')
if "अररिया" in districts:
    districts = districts[districts.index("अररिया"):]  # Start from अररिया
...
# Close WebDriver
driver.quit()
print("✅ Extraction complete! Data saved to 'gram_panchayat_mukhiya_results(9).csv'")
